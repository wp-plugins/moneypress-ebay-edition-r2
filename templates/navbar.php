...
<ul>
    <li class='like-a-button'><a href="<?php echo admin_url(); ?>options-general.php?page=csl-mp-ebay-options">Settings: General</a></li>
</ul>
...
//
global $submenu, $MP_ebay_plugin;
$content =
    '<ul>';

// Loop through all SLP sidebar menu items on admin page
//
foreach ($submenu[MP_EBAY_PREFIX . '-options'] as $menu_item) {
...
$content .= apply_filters('mpeby_navbar_item','');
$content .='</ul>';
echo apply_filters('mpeby_navbar',$content);
