...
class wpCSL_settings__mpebay {
    ...
    function add_section($params) {
        $this->sections[$params['name']] = new wpCSL_settings_section__mpebay(
            array_merge(
                $params,
    ...
    function show_plugin_settings() {
        ...
        $content .= "<input type=\"text\"".
            ...
            "\"". ((get_option($this->prefix.'-purchased')) ? 'disabled' : '') .
            " />";
...
/****************************************************************************
 **
 ** class: wpCSL_settings_section__mpebay
 **
 **/
class wpCSL_settings_section__mpebay {
    ...
    function add_item($params) {
        $this->items[] = new wpCSL_settings_item__mpebay(
            array_merge(
                $params,
                array('plugin_url' => $this->plugin_url)
            )
...
/****************************************************************************
 **
 ** class: wpCSL_settings_item__mpebay
 **
